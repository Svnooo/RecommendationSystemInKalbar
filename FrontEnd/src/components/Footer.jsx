      ...
      <footer className="relative w-full">
        <div className="mx-auto w-full max-w-7xl px-8">
          <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
            <Typography type="h6" className="mb-2"> {/* Reduced margin here */}
              Arkanaya
            </Typography>
          ...
          <div className="mt-6 flex w-full flex-col items-center justify-center gap-4 border-t border-surface py-2 md:flex-row md:justify-between"> 
            <Typography type="small" className="text-center">
              &copy; {YEAR}{" "}
              <a href="https://material-tailwind.com/">Arkanaya</a>. All Rights Reserved.
            </Typography>
